...
public sealed class DBHelper
{
    ...
    {
        get { return BaseConfig.ConnectionString; }
    }
    ...
    /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
    /// <returns>A dataset containing the resultset generated by the command</returns>
    public static DataSet ExecuteDataset_Trans(SqlTransaction transaction, CommandType commandType, 
    ...
    /// <summary>
    /// Execute a sp which is non-paramters, and only return the number of lines being influenced.
    /// Note: It cannot accept return values.
    /// </summary>
    /// <param name="procName"></param>
    /// <returns></returns>
    public static int RunProc(string procName)
    {
        return ExecuteNonQuery(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    {
        return ExecuteNonQuery(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    /// <summary>
    /// Execute a sp which is non-parameters, and return type is SqlDataReader.
    /// </summary>
    /// <param name="procName"></param>
    /// <returns></returns>
    public static void RunProc(string procName, out SqlDataReader reader)
    {
        reader = ExecuteReader(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }

    /// <summary>
    /// Execute a sp which has parameters, and return type is SqlDataReader.
    /// </summary>
    /// <param name="procName"></param>
    /// <param name="prams"></param>
    /// <returns></returns>
    ...
    {
        reader = ExecuteReader(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }

    /// <summary>
    /// Execute a sp which is non-parameters, and return type is DataSet.
    /// </summary>
    /// <param name="procName"></param>
    /// <returns></returns>
    public static void RunProc(string procName, out DataSet ds)
    {
        ds = ExecuteDataset(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }

    /// <summary>
    /// Execute a sp which has parameters, and return type is DataSet.
    /// </summary>
    /// <param name="procName"></param>
    /// <param name="prams"></param>
    /// <returns></returns>
    ...
    {
        ds = ExecuteDataset(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    ...
    /// </summary>
    /// <param name="procName">Store procedure's name.</param>
    /// <returns></returns>
    public static void RunProc(string procName, out object obj)
    {
        obj = ExecuteScalar(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    {
        obj = ExecuteScalar(DBHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    ...
    {
        xmlReader = ExecuteXmlReader(new SqlConnection(DBHelper.ConnectionString), CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    {
        xmlReader = ExecuteXmlReader(new SqlConnection(DBHelper.ConnectionString), CommandType.StoredProcedure, procName, prams);
    }
...
partial class DataBaseAccess
{
    ...
    public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static SqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteReader(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
        }
    }
    ...
    public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
    {
        ...
        if (dataRow != null && dataRow.ItemArray.Length > 0)
        {
            ...
            return DataBaseAccess.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        }
        else
        {
            return DataBaseAccess.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
        }
    }
    #endregion
    ...
    public static int RunProc(string procName)
    {
        return ExecuteNonQuery(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    public static int RunProc(string procName, SqlParameter[] prams)
    {
        return ExecuteNonQuery(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    /// <summary>
    ...
    public static void RunProc(string procName, out SqlDataReader reader)
    {
        reader = ExecuteReader(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    public static void RunProc(string procName, SqlParameter[] prams, out SqlDataReader reader)
    {
        reader = ExecuteReader(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    ...
    public static void RunProc(string procName, out DataSet ds)
    {
        ds = ExecuteDataset(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    public static void RunProc(string procName, SqlParameter[] prams, out DataSet ds)
    {
        ds = ExecuteDataset(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    ...
    public static void RunProc(string procName, out object obj)
    {
        obj = ExecuteScalar(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    public static void RunProc(string procName, SqlParameter[] prams, out object obj)
    {
        obj = ExecuteScalar(DataBaseAccess.ConnectionString, CommandType.StoredProcedure, procName, prams);
    }
    ...
    public static void RunProc(string procName, out XmlReader xmlReader)
    {
        xmlReader = ExecuteXmlReader(new SqlConnection(DataBaseAccess.ConnectionString), CommandType.StoredProcedure, procName, (SqlParameter[])null);
    }
    ...
    public static void RunProc(string procName, SqlParameter[] prams, out XmlReader xmlReader)
    {
        xmlReader = ExecuteXmlReader(new SqlConnection(DataBaseAccess.ConnectionString), CommandType.StoredProcedure, procName, prams);
    }
...
sealed class ParamsCache
{
    ...
    /// <summary>
    /// 得到缓存中的存储过程参数。如果能得到,返回true,并out参数出来,不能得到,则parms = null,返回false;
    /// </summary>
