...
namespace Lab
{
    ...
    public enum CarType
    {
        [StringValue("Saloon / Sedan")]
        Saloon = 5,
        [StringValue("Coupe")]
        Coupe = 4,
        [StringValue("Estate / Wagon")]
        Estate = 6,
        [StringValue("Hatchback")]
        Hatchback = 8,
        [StringValue("Utility")]
        Ute = 1,
    }
    ...
    public class TestStringEnum
    {
        static void Main(string[] args)
        {
            Console.WriteLine(StringEnum.GetStringValue(CarType.Saloon));
            Console.WriteLine(StringEnum.GetStringValue(CarType.Coupe));
