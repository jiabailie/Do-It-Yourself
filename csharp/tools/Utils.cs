...
namespace PHConsultant.Common
{
    ...
    public class Utils
    {
        public const string ASSEMBLY_VERSION = "0.0.1.15";
        ...
        {
            return GetPageNumbers(curPage, countPage, url, extendPage, "curpage");
        }
        ...
        public static string GetPageNumbers(int curPage, int countPage, string url, int extendPage, string pagetag, string anchor)
        {
            ...
            string t3 = "<a href=\"" + url + "&" + pagetag + "=" + (curPage - 1);
            string t4 = "<a href=\"" + url + "&" + pagetag + "=" + (curPage + 1);
            ...
            s.Append(t4);
            s.Append(t2);
            string redirect = "<span><input name=\"gopage\" type=\"text\" id=\"gopage\" style=\"width:20px;\" />&nbsp;<input type=\"button\" class=\"button\" value=\"跳转\" onclick=\"window.location.href='"
                + url + pagetag + "='+document.getElementById('gopage').value;\"/></span>";
            s.Append(redirect);
            return s.ToString();
        }
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns></returns>
        public static decimal StrToDeciaml(string expression, decimal defValue)
        {
        ...
        /// 取指定长度的中文汉字的首拼音大写字母
        /// </summary>
        /// <param name="strText">中文汉字</param>
        /// <param name="length">取字符长度</param>
        /// <returns></returns>
        public static string GetChineseSpell(string strText, int length)
        {
            int _len = (strText.Length > length) ? length : strText.Length;
            return GetSubString(GetChsSpell(strText), _len, string.Empty);
        }
        ...
        private static string GetChsSpell(string strText)
        {
        ...
        private static string GetSpell(string cnChar)
        {
            ...
            if (arrCN.Length > 1)
            {
                ...
                int code = (area << 8) + pos;
                int[] areacode ={45217,45253,45761,46318,46826,47010,47297,47614,48119,48119,49062,49324,49896,50371,50614,50622,50906,51387,
        ...
        /// 输出xml
        /// </summary>
        /// <param name="builder">传入的文本内容</param>
        public static void ResponseXml(StringBuilder builder)
        {
        ...
        /// </summary>
        /// <param name="content"></param>
        public static void ResponseListXml(string content)
        {
        ...
        /// </summary>
        /// <param name="content"></param>
        public static void ResponseListXml(string content, int count)
        {
            StringBuilder _sb = new StringBuilder();
            _sb.Append("<?xml  version=\"1.0\" encoding=\"utf-8\"?> \r\n");
            _sb.Append("<data count=\"" + count + "\">\r\n");
            _sb.Append(content);
            _sb.Append("</data>");
            Utils.ResponseXml(_sb);
        }
        ...
        /// </summary>
        /// <param name="builder">传入的文本内容</param>
        public static void ResponseXml(string builder)
        {
            System.Web.HttpContext.Current.Response.Buffer = true;
            System.Web.HttpContext.Current.Response.ContentType = "text/xml";
            System.Web.HttpContext.Current.Response.Clear();
        ...
        public static void CreateXml(string code, string description)
        {
            StringBuilder _sb = new StringBuilder();
            _sb.Append("<?xml  version=\"1.0\" encoding=\"utf-8\"?> \r\n");
            _sb.Append("<article>\r\n");
            _sb.Append("<action>" + code + "</action>\r\n");
            _sb.Append("<desc>" + description + "</desc>\r\n");
            _sb.Append("</article>");
            Utils.ResponseXml(_sb);
        }
    } 
